...
Third Quantile covers most of the data. Percent coverage for fatalities is `r percentFatalities` % and for injuries is `r percentInjuries` %. Further analysis is done on this data.